...
goog.exportSymbol('proto.unitodo.TodoDonePair', null, global);
 ...
 * @constructor
 */
proto.unitodo.TodoDonePair = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.unitodo.TodoDonePair, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.unitodo.TodoDonePair.displayName = 'proto.unitodo.TodoDonePair';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.unitodo.ConfigMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    todoDonePairsList: jspb.Message.toObjectList(msg.getTodoDonePairsList(),
    proto.unitodo.TodoDonePair.toObject, includeInstance),
...
proto.unitodo.ConfigMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.unitodo.TodoDonePair;
      reader.readMessage(value,proto.unitodo.TodoDonePair.deserializeBinaryFromReader);
      msg.addTodoDonePairs(value);
      break;
    case 6:
      var value = /** @type {string} */ (reader.readString());
...
proto.unitodo.ConfigMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTodoDonePairsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.unitodo.TodoDonePair.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.unitodo.TodoDonePair>}
 */
proto.unitodo.ConfigMessage.prototype.getTodoDonePairsList = function() {
  return /** @type{!Array<!proto.unitodo.TodoDonePair>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.unitodo.TodoDonePair, 5));
};


/**
 * @param {!Array<!proto.unitodo.TodoDonePair>} value
 * @return {!proto.unitodo.ConfigMessage} returns this
*/
proto.unitodo.ConfigMessage.prototype.setTodoDonePairsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 5, value);
};


/**
 * @param {!proto.unitodo.TodoDonePair=} opt_value
 * @param {number=} opt_index
 * @return {!proto.unitodo.TodoDonePair}
 */
proto.unitodo.ConfigMessage.prototype.addTodoDonePairs = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.unitodo.TodoDonePair, opt_index);
};
 ...
 * @return {!proto.unitodo.ConfigMessage} returns this
 */
proto.unitodo.ConfigMessage.prototype.clearTodoDonePairsList = function() {
  return this.setTodoDonePairsList([]);
};
 ...
 * @return {!Object}
 */
proto.unitodo.TodoDonePair.prototype.toObject = function(opt_includeInstance) {
  return proto.unitodo.TodoDonePair.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.unitodo.TodoDonePair} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.unitodo.TodoDonePair.toObject = function(includeInstance, msg) {
  var f, obj = {
    todoMarker: jspb.Message.getFieldWithDefault(msg, 1, ""),
    doneMarker: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.unitodo.TodoDonePair}
 */
proto.unitodo.TodoDonePair.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.unitodo.TodoDonePair;
  return proto.unitodo.TodoDonePair.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.unitodo.TodoDonePair} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.unitodo.TodoDonePair}
 */
proto.unitodo.TodoDonePair.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setTodoMarker(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setDoneMarker(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.unitodo.TodoDonePair.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.unitodo.TodoDonePair.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.unitodo.TodoDonePair} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.unitodo.TodoDonePair.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTodoMarker();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string todo_marker = 1;
 * @return {string}
 */
proto.unitodo.TodoDonePair.prototype.getTodoMarker = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.unitodo.TodoDonePair} returns this
 */
proto.unitodo.TodoDonePair.prototype.setTodoMarker = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string done_marker = 2;
 * @return {string}
 */
proto.unitodo.TodoDonePair.prototype.getDoneMarker = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.unitodo.TodoDonePair} returns this
 */
proto.unitodo.TodoDonePair.prototype.setDoneMarker = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
